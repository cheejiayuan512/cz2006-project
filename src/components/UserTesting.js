                    ...
                    <div className="bs-stepper-content">
                        <Form onSubmit={this.onSubmit}>
                            <div id="test-l-1" className="content">
                                <Form.Group>
                                    <Form.Label column='lg' className='font-weight-bold' style={{fontSize:'150%'}}>Let's get started! What is your name?</Form.Label>
                                    <Form.Control required name="userName" type="text" placeholder="Bob Bob??!"  value={this.state.userName} onChange={this.handleNameChange} />
                            ...
                            <div id="test-l-2" className="content">
                                <Form.Group>
                                    <Form.Label column='lg' className='font-weight-bold' style={{fontSize:'150%'}}>When are your preferred timings?</Form.Label>
                                    <div>
                                        <Timetable onCallback={this.handleTimetable} startTime='10:00' timeSlots={5} startDate="03/08/2021" endDate="03/14/2021" />
                            ...
                            <div id="test-l-3" className="content text-center">
                                <Form.Label column='lg' className='font-weight-bold' style={{fontSize:'150%'}}>What is your budget?</Form.Label>
                                <Form.Control required onChange={this.handleBudgetChange}  type="radio" format='dd/mm/yyyy'>
                                </Form.Control>
                                <Form.Text className="text-muted">Tip: Just get your friends to treat you.</Form.Text>
                            ...
                            <div id="test-l-4" className="content text-center">
                                <Form.Group>
                                    <Form.Label column='lg' className='font-weight-bold' style={{fontSize:'150%'}}>What is your preferred cuisine?</Form.Label>
